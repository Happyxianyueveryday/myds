...
int main(void)
{
	...
	LinkedList<int> lis5(move(lis2));
	cout<<lis5.toString()<<endl;
	cout<<lis2.toString()<<endl;
	
	LinkedList<int> lis6=lis2=move(lis5);
	cout<<lis6.toString()<<endl;
	cout<<lis5.toString()<<endl;
}
