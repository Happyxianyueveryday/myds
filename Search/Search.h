...
{
	public:
	static int linear_search(T data[], int size, T val);
	static int binary_search(T data[], int size, T val); 
};
 ...
 */
template<typename T> 
int Search<T>::linear_search(T data[], int size, T val)
{
 ...
 */
template<typename T> 
int Search<T>::binary_search(T data[], int size, T val)
{
