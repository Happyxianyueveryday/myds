...
int main(void)
{
	...
	cout<<"--------------------------------------------"<<endl;
	ThreadPreTree threadtree1(tree1);
	ThreadPreTree threadtree2(tree2);

	print("线索树tree1 前序遍历 = ", threadtree1.preorder());
	print("线索树tree2 前序遍历 = ", threadtree2.preorder());
}
